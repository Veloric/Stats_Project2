...
public class Tester {
    ...
    public static void main(String[] args){
        ...
        for(int i = 0; i < data.size(); i++){
            ...
            System.out.println("Bought / Sold: " + simulation.unsafeTrader(i) + " shares at " + data.get(i).getOpen() + " | Remaining Balance: $" + simulation.getBalance() + " | Owned Shares: " + simulation.getShares());
